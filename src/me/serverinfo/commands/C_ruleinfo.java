...
public class C_ruleinfo implements CommandExecutor
{

    public C_ruleinfo(ServerInfo plugin)
    {     
    }
    ...
    public boolean onCommand(CommandSender cs, Command cmnd, String string, String[] strings)
    {
        ...
        {
	    Player p = (Player) cs;	
	    p.sendMessage(ChatColor.BLUE + ServerInfo.plugin.getConfig().getString("rulesinfo"));
	}
